...
const INITIAL_BARANG_SEED = [
  { kode: 'STK-001', nama: 'Yellowfin Tuna (YFT)', kategori: 'Whole Round 2-4 kg up', cabang: 'Jakarta', satuan: 'kg', stokAwal: 12500, lastUpdated: '30/05/2026 14:30 oleh Tami (Sales)', status: 'aktif' as const },
  ...
  { kode: 'STK-003', nama: 'Squid Loligo', kategori: 'Whole 50/100', cabang: 'Surabaya', satuan: 'kg', stokAwal: 6750, lastUpdated: '29/05/2026 16:20 oleh Dini (Cab. Surabaya)', status: 'aktif' as const },
  ...
  { kode: 'STK-005', nama: 'Octopus', kategori: 'Flower Type 1-2 kg', cabang: 'Jakarta', satuan: 'kg', stokAwal: 2300, lastUpdated: '30/05/2026 08:50 oleh Tami (Sales)', status: 'aktif' as const },
  ...
  { kode: 'STK-009', nama: 'Cakalang', kategori: '2 kg up, Grade A', cabang: 'Bitung', satuan: 'kg', stokAwal: 15000, lastUpdated: '28/05/2026 15:20 oleh Tami (Sales)', status: 'aktif' as const },
  { kode: 'STK-010', nama: 'Chirimen', kategori: 'Kering 1-2 cm', cabang: 'Bacan', satuan: 'kg', stokAwal: 6500, lastUpdated: '27/05/2026 11:30 oleh Rian (Cab. Bitung)', status: 'aktif' as const },
  { kode: 'STK-011', nama: 'Tuna Albacore', kategori: '5 kg up, FOB', cabang: 'Benoa', satuan: 'kg', stokAwal: 8600, lastUpdated: '27/05/2026 10:15 oleh Aisyah (Direksi)', status: 'aktif' as const },
  { kode: 'STK-012', nama: 'Udang Vaname', kategori: '40/50 HLSO', cabang: 'Brondong', satuan: 'kg', stokAwal: 9000, lastUpdated: '26/05/2026 16:30 oleh Bambang (Cab. Brondong)', status: 'aktif' as const },
  { kode: 'STK-013', nama: 'Kakap Merah', kategori: 'Fillet Skin-on', cabang: 'Semeleu', satuan: 'kg', stokAwal: 4500, lastUpdated: '26/05/2026 14:00 oleh Mario (Cab. Semeleu)', status: 'aktif' as const },
  { kode: 'STK-014', nama: 'Kerapu', kategori: 'Whole 1 kg up', cabang: 'Pemangkat', satuan: 'kg', stokAwal: 3500, lastUpdated: '25/05/2026 11:20 oleh Rahmat (Cab. Pemangkat)', status: 'aktif' as const },
  { kode: 'STK-015', nama: 'Tenggiri', kategori: 'Steak Frozen', cabang: 'Tegal', satuan: 'kg', stokAwal: 4200, lastUpdated: '25/05/2026 09:45 oleh La Ode (Cab. Tegal)', status: 'aktif' as const },
...
export async function POST(req: Request) {
  try {
    ...
    const existing = await Barang.findOne({ nama, cabang: cabang || 'Jakarta' });
